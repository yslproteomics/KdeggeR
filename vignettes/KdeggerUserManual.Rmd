...
It is recommended to use cross-run normalized data. 
...
o_aggregate <- KdeggeR::generatepSILACObject(dataset = data_file, design = design_table_updated, inputDataType = "spectronaut", aggregate.replicates = "median")
```